...
import { addBrevet, getDemandesDisponibles } from "/src/features/brevets/brevetApi.js";
...
export default function AddBrevet() {
  ...
  // ✅ Charger uniquement les demandes de cet agent
  useEffect(() => {
  ...
  // ✅ Pré-remplir les champs quand une demande est sélectionnée
  const handleDemandeChange = (e) => {
    ...
    setForm({
      ...form,
      id_demande_input: id,
      num_depo:  demande ? String(demande.num_depo)  : form.num_depo,
  ...
  return (
    <div className="add-page">
      <div className="add-card">
        ...
        {/* ✅ Sélection demande liée — uniquement les siennes */}
        <div className="add-section-label">Demande liée</div>
        <div className="add-grid">
          <div className="form-group">
            <label>Sélectionner une de vos demandes</label>
            <select
              name="id_demande_input"
              value={form.id_demande_input}
